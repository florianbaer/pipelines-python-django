...
|---------|--------------|
| Build (YAML) | [![Build Status](https://dev.azure.com/softwareation/HelloWorld/_apis/build/status/florianbaer.pipelines-python-django?branchName=master)](https://dev.azure.com/softwareation/HelloWorld/_build/latest?definitionId=1?branchName=master) |
